...
<body>
    ...
    <header class="site-header">
        <a class="brand" href="{{ route('home') }}" aria-label="Gani Property Services home">
            <img class="brand-logo" src="{{ asset('images/Gani-Logo.png') }}" alt="Gani Property Services">
        </a>
    ...
    <footer class="footer" id="contact-footer">
        ...
        <div class="footer-column"><h3>Navigate</h3><a href="{{ route('rent') }}">Rent</a><a href="{{ route('landlords') }}">Landlords</a><a href="{{ route('pages.show', 'services') }}">Services</a><a href="{{ route('pages.show', 'events') }}">Events</a><a href="{{ route('about') }}">About</a><a href="{{ route('contact') }}">Contact</a></div>
